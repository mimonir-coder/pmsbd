	...
	<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
		<div class="m-header">
			...
			<a href="#!" class="b-brand">
				...
				<img src="{{ asset('front/dist/images/Pms.png') }}" alt="" class="logo" style="max-height: 40px">
				<img src="{{ asset('front/dist/images/Pms.png') }}" alt="" class="logo-thumb" style="max-height: 40px">
				<h5 class="bangla_font text-white ml-3">PMS BD</h5>
			</a>
					...
					<div class="dropdown drp-user">
						...
						<div class="dropdown-menu dropdown-menu-right profile-notification">
							<div class="pro-head">
								...
								<a class="dud-logout" title="Logout" href="{{ route('admin.logout') }}" onclick="event.preventDefault();
