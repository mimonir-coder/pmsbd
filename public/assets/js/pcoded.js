...
// more-details end
$("body").append('<div class="fixed-button active d-none"><a href="#" target="_blank" class="btn btn-md btn-primary"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Upgrade To Pro</a> </div>');
